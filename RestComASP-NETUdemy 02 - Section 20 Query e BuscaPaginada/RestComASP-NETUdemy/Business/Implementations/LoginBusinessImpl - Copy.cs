...
namespace RestComASPNETUdemy.Business.Implementations
{
  ...
  {
    private ILoginRepository iUserRepository;
    private SigningConfigurations _signingConfigurations;
    private TokenConfiguration _tokenConfiguration;

    public LoginBusinessImpl(ILoginRepository repository, SigningConfigurations signing, TokenConfiguration tokenConfiguration) {
    ...
    public object FindByLogin(User user) {
      ...
      if (user != null && !string.IsNullOrWhiteSpace(user.Login)) {
        ...
        var baseUser = iUserRepository.FindByLogin(user.Login);
